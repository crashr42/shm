...
class Classes.ByManager
  constructor: ->
    @parts =
      'seconds':    new BySecond()
      'minutes':    new ByMinute()
      'hours':      new ByHour()
      'month_days': new ByMonthDay()
      'year_days':  new ByYearDay()
      'weeks':      new ByWeekNumber()
      'positions':  new ByPosition()
      'months':     new ByMonth()
      'week_days':  new ByWeekDays()
